                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div v-for="cinema in cinemas" :key="cinema.id">
                                <button
                                    ...
                                    :class="{ 'bg-blue-600 text-white': selectedCinema.id === cinema.id }"
                    ...
                    <div class="px-6 py-4 bg-white">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div v-for="screen in screens" :key="screen.id">
                                <button
                                    class="focus:outline-none bg-white border border-gray-300 rounded-lg py-2 px-20 w-full justify-center items-center flex transition duration-150 ease-in-out"
                                    :class="{ 'bg-blue-600 text-white': selectedScreen === screen.name }"
            ...
            <div v-else-if="showDateSelection && selectedScreen != ''">
                    ...
                    <div class="flex px-2">
                        <div class="flex space-x-2">
                            <button
                                ...
                                :class="{ 'bg-blue-600 text-white': selectdate === dateObj.day }"
                ...
                <div class='flex px-2' v-if="selectdate != ''">
                    <button v-for="datetime in time" :key='datetime.id'
                        ...
                        :class="{ 'bg-blue-600 text-white': selecttime === datetime.period }"
                        @click="selectTime(datetime.period)">{{ datetime.period }}</button>
                </div>
                <div v-if="selecttime != ''" class='mt-5'>
                    <seatRow ref="seatRow" @seats-selected='onSeatsSelected' :selectedSeats="Seats"></seatRow>
                </div>
...
export default {
    ...
    methods: {
        ...
        booking() {
            let newBooking = { movie: this.movie, cinema: this.selectedCinema, location: this.selectedLocation, screen: this.selectedScreen, date: this.selectdate, time: this.selecttime, seats: this.Seats, price: (this.movie.price * this.Seats.length) }
